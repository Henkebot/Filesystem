...
{
	//Create Thread ID for user interaction
	pthread_t userInteractionID;
	...
	//Waiting for user interaction thread to finnish
	pthread_join(userInteractionID,NULL);
	...
	pthread_create(&userInteractionID, NULL, userInteraction, NULL);
